        ...
        <form onSubmit={handleSubmit(onSubmit)} className="">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex justify-between items-center">
              <button
                className="border w-24 mt-5 bg-[#118024]/90 text-white px-2 py-3 rounded-lg border-transparent"
                onSubmit={notify}
              >
                Login
              </button>
              <button className="flex items-center justify-center space-x-1 border-[#118024] border-2 w-24 px-2 py-3 mt-5 rounded-lg">
